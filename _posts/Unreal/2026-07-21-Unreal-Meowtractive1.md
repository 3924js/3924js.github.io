...
다만 프로젝트 발표 시점에는 사용되지 못했다. 기능은 모두 동작했지만 기능 구현 후에 모듈형 캐릭터 외형에 대해 의견이 갈렸고 다른 단순 캐릭터로 변경됬기 때문이다. 팀 차원에서 진행 전에 의견과 방향성을 검토하고 조율하는 것, 그리고 적절한 에셋이나 방법을 탐색하고 유의미한 결과의 합의점을 사전에 도출하는 것의 중요함을 경험하는 부분이다.